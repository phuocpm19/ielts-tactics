...
import TaiLieuChiTiet from '@/screens/TaiLieu/ChiTiet';

const TaiLieuChiTietPage: NextPage<TPostCommon> = ({ id, title, desc, createAt, content, thumbnail }) => {
  return (
    <>
      <HeadSeo title="Chi tiet tai lieu" />

      <Layout>
        <TaiLieuChiTiet id={id} title={title} desc={desc} createAt={createAt} content={content} thumbnail={thumbnail} />
      </Layout>
    </>
  );
};
...
export default TaiLieuChiTietPage;
