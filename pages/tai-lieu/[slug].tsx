...
const TaiLieuChiTietPage: NextPage<TArticle> = ({ id, title, desc, createAt, content, thumbnail, slug, show }) => {
  return (
    <>
      <HeadSeo title={title} srcSeo={`${Paths.TaiLieu}/${slug}`} desc={desc} thumbnail={thumbnail} />
