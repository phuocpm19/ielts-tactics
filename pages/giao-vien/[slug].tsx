...
const GiaoVienChiTietPage: NextPage<TArticle> = ({ id, title, desc, createAt, content, thumbnail, slug, show }) => {
  return (
    <>
      <HeadSeo title={title} srcSeo={`${Paths.GiaoVien}/${slug}`} desc={desc} thumbnail={thumbnail} />
