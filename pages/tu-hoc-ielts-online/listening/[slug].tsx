...
import TuHocIeltsListeningChiTiet from '@/screens/TuHocIeltsOnline/Listening/ChiTiet';

const TuHocIeltsListeningChiTietPage: NextPage<TPostCommon> = ({ id, title, desc, createAt, content, thumbnail }) => {
  return (
    <>
      <HeadSeo title="Chi tiet listening" />

      <Layout>
        <TuHocIeltsListeningChiTiet
          id={id}
          title={title}
          desc={desc}
          createAt={createAt}
...
export default TuHocIeltsListeningChiTietPage;
