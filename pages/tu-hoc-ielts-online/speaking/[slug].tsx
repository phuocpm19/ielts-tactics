...
import TuHocIeltsSpeakingChiTiet from '@/screens/TuHocIeltsOnline/Speaking/ChiTiet';

const TuHocIeltsSpeakingChiTietPage: NextPage<TPostCommon> = ({ id, title, desc, createAt, content, thumbnail }) => {
  return (
    <>
      <HeadSeo title="Chi tiet speaking" />

      <Layout>
        <TuHocIeltsSpeakingChiTiet
          id={id}
          title={title}
          desc={desc}
          createAt={createAt}
...
export default TuHocIeltsSpeakingChiTietPage;
