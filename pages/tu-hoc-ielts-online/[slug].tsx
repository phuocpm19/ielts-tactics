...
const TuHocIeltsOnlineChiTietPage: NextPage<TArticle> = ({
  id,
  title,
  desc,
  createAt,
  ...
  return (
    <>
      <HeadSeo title={title} srcSeo={`${Paths.TuhocIeltsOnline}/${slug}`} desc={desc} thumbnail={thumbnail} />
...
export default TuHocIeltsOnlineChiTietPage;
