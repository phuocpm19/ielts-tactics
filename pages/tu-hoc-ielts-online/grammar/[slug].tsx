...
const TuHocIeltsGrammarChiTietPage: NextPage<TArticle> = ({
  id,
  title,
  desc,
  createAt,
  ...
  return (
    <>
      <HeadSeo title={title} srcSeo={`${Paths.TuhocIeltsOnlineGrammar}/${slug}`} desc={desc} thumbnail={thumbnail} />
...
export default TuHocIeltsGrammarChiTietPage;
