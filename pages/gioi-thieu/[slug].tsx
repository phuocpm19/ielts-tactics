...
const GioiThieuChiTietPage: NextPage<TArticle> = ({ id, title, desc, createAt, content, thumbnail, slug, show }) => {
  return (
    <>
      <HeadSeo title={title} srcSeo={`${Paths.GioiThieu}/${slug}`} desc={desc} thumbnail={thumbnail} />
